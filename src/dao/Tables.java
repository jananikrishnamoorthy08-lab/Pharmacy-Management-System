    ...
    public static void main(String[] args) {
        try {
            ...
            Statement st = con.createStatement();
             ...
             st.executeUpdate("insert into appuser (userRole,name,dob,MobileNumber,email,username,password,address) values('Admin','Admin','01-07-2000', '1234567890','admin123@gmail.com','admin','admin','India')");
            ...
            JOptionPane.showMessageDialog(null, "Sucessfully Table Created");
        } catch (Exception e) {
